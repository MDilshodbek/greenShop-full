...
const Newsletter = () => {
  return (
    <div>
      <div className="w-full h-[250px] bg-[#fbfbfb] flex justif-between p-[25px] gap-[60px] max-md:hidden">
      ...
      <div className="hidden max-md:flex flex-col w-full bg-[#fbfbfb] p-[23px]">
        <div className="flex flex-col items-center justify-around w-full gap-[25px]">
          <div className="flex flex-col items-left w-full border-b-2 pr-[23px] pb-[23px] border-[#46A358]">
            <img
              className="w-[77px] h-[95px]"
              src={garder}
              alt="garden care image"
        ...
        <div className="w-full mt-6">
          ...
          <div className="flex items-center justify-center relative my-[18px]">
            <input
              type="email"
              placeholder="enter your email address..."
              className="w-full h-[40px] bg-[#ffffff] rounded-md"
            />
            <button className="bg-[#46a358] text-white font-bold flex items-center justify-center text-[18px] rounded-r-md w-[85px] h-[40px] absolute right-0">
              Join
            </button>
